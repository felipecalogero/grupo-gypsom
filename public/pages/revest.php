...
<head>
    ...
    <title>Grupo Gypsom - Revest</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-3 contentImage text-center">
                    <img class="desktop" src="assets/img/revest/isolamento.png" alt="imgIsolamento1">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p>Existem dois tipos de piso vinílico: um para área residencial e outra comercial. Ambas possuem o sistema de instalação em click ou colado. Em relação ao melhor custo benefício, a cola é uma ótima opção. Porém o investimento maior do click oferece a vantagem de remover a régua sem danificar o produto.</p><br>
    ...
    <img class="imgFooter" src="assets/img/revest/borda.png" alt="imgPiso4">
